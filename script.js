...
const allQuestions = [
    ...
    { question: "Quants centres logístics té Fedefarma?", answers: ["7", "8", "9", "10"], correct: 3 },
    { question: "Quantes referències té el catàleg de Fedefarma?", answers: ["100.000", "125.000", "150.000+", "175.000"], correct: 2 },
    { question: "Fedefarma té més de quants anys?", answers: ["80", "90", "95", "100"], correct: 2 },
    ...
    { question: "La formació de MENTORA garanteix...?", answers: ["Formació única i permanent", "Actualització constant dels coneixements", "Només certificacions oficials", "Cursos intensius curts"], correct: 1 },
    ...
    { question: "Què caracteritza els professionals docents de MENTORA?", answers: ["Estudiants universitaris", "Els millors professionals, reputats i especialistes en cada temàtica", "Professors exclusivament universitaris", "Consultors externs independents"], correct: 1 },
    { question: "En què s'adapta la formació de MENTORA?", answers: ["No s'adapta en cap cas", "A tu i a la teva farmàcia: on, quan i com vulguis", "Només a horaris fixos predeterminats", "Només a través de plataforma online"], correct: 1 },
    { question: "El PFC serveix per...?", answers: ["Aprendre gestió empresarial", "Estar al dia de les darreres actualitzacions en farmacoteràpia i practicar casos", "Aprendre veterinària", "Aprendre màrqueting farmacèutic"], correct: 1 },
    { question: "El PFG està dissenyat amb quina escola?", answers: ["Universitat de Barcelona", "ESIC Business & Marketing School", "UPC", "UAB"], correct: 1 },
    { question: "En què profunditza el PFG?", answers: ["Només farmacoteràpia", "Totes les àrees de gestió i direcció de la farmàcia", "Només màrqueting", "Només finances i comptabilitat"], correct: 1 },
    { question: "El PFVet està dissenyat per capacitar en...?", answers: ["Medicaments humans exclusivament", "Dispensació i consell en medicaments veterinaris", "Farmàcia hospitalària", "Anàlisis clínics"], correct: 1 },
    { question: "El PFW és una formació amb perspectiva de...?", answers: ["Científica i tècnica", "Gènere", "Econòmica i de negoci", "Social"], correct: 1 },
    { question: "Què significa que MENTORA és un ecosistema formatiu?", answers: ["Només un curs puntual", "Un conjunt de programes i formats que garanteix l'actualització constant", "Només llibres acadèmics", "Només podcasts i vídeos"], correct: 1 },
